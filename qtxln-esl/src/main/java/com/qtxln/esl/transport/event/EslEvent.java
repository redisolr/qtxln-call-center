package com.qtxln.esl.transport.event;
 ...
 * original containing {@link com.qtxln.esl.transport.message.EslMessage} which carried the event are also available.
 * <p>
 ...
 * <p>
 * The messageHeader lines from the original message are cached in a map keyed by {@link com.qtxln.esl.transport.message.EslHeaders.Name}.
 *
 * @author 秦腾
 * @version 1.0
 * @date 2020/5/11 13:42 下午
 * @since 1.0
 */
@Slf4j
public class EslEvent {
   ...
   *
   * @param rawMessage a {@link com.qtxln.esl.transport.message.EslMessage} object.
   */
   ...
   * The message headers are stored in a map keyed by {@link com.qtxln.esl.transport.message.EslHeaders.Name}. The string mapped value
